# this command initializes the model up front!


#dyn.load("C:\\Usask\\Research\\VensimMCMC\\VensimRCompatibleDLL\\RVensimInterface8.dll")
#source("C:\\Usask\\Research\\VensimMCMC\\VensimRCompatibleDLL\\RVensimInterface4.R")
#source("C:\\Usask\\Research\\VensimMCMC\\VensimRCompatibleDLL\\MCMCPackageVensimV7 parameters beta and p logit transformed alpha #log transformed.R")
#history(Inf)
#setLoggingThreshold(as.integer(-1))
#setIsVensimWorkInProgressWindowToBeShown(as.integer(0))
#library(MCMCpack)

#loadVensimModel("C:\\Usask\\Research\\VensimMCMC\\VensimRCompatibleDLL\\First SIR Model v3 Recovery Coefficient.vpm")
